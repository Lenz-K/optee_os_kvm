...
To download the necessary sources and build OP-TEE, create a script with the contents of [build_kvm.sh](https://github.com/Lenz-K/optee_os_kvm/blob/plat-kvm/build_kvm.sh) and place it in a directory of your choice and execute it.
